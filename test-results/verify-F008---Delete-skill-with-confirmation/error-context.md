...
- Name: verify.spec.ts >> F008 - Delete skill with confirmation
- Location: verify.spec.ts:272:1
...
Locator: [data-testid="delete-skill"], button:has-text("Delete"), text=Delete
Expected: visible
Error: Unexpected token "=" while parsing css selector "[data-testid="delete-skill"], button:has-text("Delete"), text=Delete". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 2000ms
  - waiting for [data-testid="delete-skill"], button:has-text("Delete"), text=Delete
...
> 286 |   await expect(deleteBtn).toBeVisible({ timeout: 2000 })
  ...
  353 | 
  354 |   // Fill in path (type it manually — folder picker not testable)
  355 |   const pathInput = window.locator('[data-testid="project-path-input"], input[name="projectPath"], input[placeholder*="path"]')
